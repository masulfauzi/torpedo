    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('jurnalmengajar.index') }}" method="get">
                    ...
                    <div class="col-3">  
						{!! button('jurnalmengajar.create', $title) !!}  
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('jurnalmengajar.show','', $item->id) !!}
										{!! button('jurnalmengajar.edit', $title, $item->id) !!}
                                        {!! button('jurnalmengajar.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
