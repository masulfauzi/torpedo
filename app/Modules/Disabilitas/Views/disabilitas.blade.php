        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">  
						{!! button('disabilitas.create', $title) !!}  
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
									...
									<td>{{ $item->kode_disabilitas }}</td>
									
                                    <td>
										{!! button('disabilitas.show','', $item->id) !!}
										{!! button('disabilitas.edit', $title, $item->id) !!}
                                        {!! button('disabilitas.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
